...
var titleFontsize = 12, labelFontsize = 16;                     // Text sizes.
...
function plotE() {
    layoutE = {
        ...
        titlefont: {size: titleFontsize}, margin: {l: marL, r: marR, b: marB + 10, t: marT},
        xaxis: {title: "t / s", titlefont: {size: labelFontsize}, range: [0, GRAPH_TIME], nticks: 20},
...
function plotLJ() {
    LJ_layout = {title: "Lennard-Jones Potential", titlefont: {size: 12},
                ...
                yaxis: {range: [-1.1 * potential.e, 0.7 * potential.e],
                    nticks: 20, title: "U / eV", titlefont: {size: labelFontsize}},
                xaxis: {range: [0.9 * potential.s, 3 * potential.s],
                    nticks: 20, title: "r" + "AB".sub() + " / nm", titlefont: {size: labelFontsize}}};
...
function reset(){
    ...
    scatterLJ  = mol1.V.plotLJ(35);
    scatterEP = mol1.V.plotLJCorr(35, mol1.L, mol1.reducedM);
    ...
    var graphsDiv = $('.graphs');                                       // Selecting all divs where all graphs located.
    var $graphsWidth = graphsDiv.css('width');                          // Storing current width of graphs.
    plotLJ();
    plotE();
    $(graphsDiv).css("width", $graphsWidth);                            // Restoring graph widths.
}
