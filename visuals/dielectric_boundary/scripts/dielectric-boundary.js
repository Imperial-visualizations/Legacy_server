$(window).on('load', function() {
    ...
    /**
    * Initialisation
    * @param {array} data - The 3d plot data
    * @param {array} dataFres - The 2d Fresnel coefficients plot data
    */
    ...
    * @param {Object} domInput - The jQuery DOM object for the slider/input[type="range"] whose value is being measured
    * @param {array} array - The array from which to fetch the plot data
    * @returns {int}
    */
    ...
    /**
    * Round a given input value to the actual value in the array
    * @param {Object} domInput - The jQuery DOM object for the slider/input[type="range"] whose value is being measured
    * @param {array} array - The array from which to fetch the plot data
    * @returns {string}
    */
