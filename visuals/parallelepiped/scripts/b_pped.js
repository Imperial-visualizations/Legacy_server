...
function makeTableInputU(m, n) {
    ...
    for (var i=0; i<m; i++) {
        ...
        for (var j=0; j<n; j++){
            if (i === 0) {
                var myString = 'Urow'+String(i)+"col"+String(j);
                result += "<td>"+"<input class='numberInput' style='width:100px;' type='number' id="+myString+
                    " value='1'"+">"+"</td>";
            } else {
            var myString = 'Urow'+String(i)+"col"+String(j);
                result += "<td>"+"<input class='numberInput' style='width:100px;' type='number' id="+myString+
...
function makeTableInputV(m, n) {
    ...
    for (var i=0; i<m; i++) {
        ...
        for (var j=0; j<n; j++){
            if (i === 1) {
                var myString = 'Vrow'+String(i)+"col"+String(j);
                result += "<td>"+"<input class='numberInput' style='width:100px;' type='number' id="+myString+
                    " value='1'"+">"+"</td>";
            } else {
                var myString = 'Vrow'+String(i)+"col"+String(j);
...
function makeTableInputW(m, n) {
    ...
    for (var i=0; i<m; i++) {
        ...
        for (var j=0; j<n; j++){
            if (i === 2) {
                var myString = 'Wrow'+String(i)+"col"+String(j);
                result += "<td>"+"<input class='numberInput' style='width:100px;' type='number' id="+myString+
                    " value='1'"+">"+"</td>";
            } else {
                var myString = 'Wrow'+String(i)+"col"+String(j);
...
*/
function main() {
    $("#u").html(makeTableInputU(3,1));
    $("#v").html(makeTableInputV(3,1));
    $("#w").html(makeTableInputW(3,1));
    ppedPlotter();
