    ...
    var n = 801;
    var x = [], y_i = [], y_r = [], y_rs = [], y_t = [];
    var t = 0.0;
    var dt = 0.02;
    var v1 = 1;
    var alpha = 0.1;
    var v2 = alpha*v1;
    var A = (1/v1-1/v2)/(1/v1+1/v2);
    var B = 2/v1*(1/(1/v1+1/v2));
    var is_paused = true;
    var layout =
        {
            autosize: false,
    ...
    var incident = {
        ...
        y: y_i,
        name: "incident",
        line: {width: 2, color: '#751E66', simplify: false}
    };
    ...
    var reflected = {
        ...
        y: y_r,
        name: "reflected",
        line: {width: 2, color: '#DD2501', simplify: false}
    };

    var reflected_sum = {
        x: x,
        y: y_r,
        name: "reflected + incident",
        line: {width: 2, color: '#0091D4', simplify: false, dash: 'dot'}
    };
    ...
    var transmitted = {
        ...
        y: y_t,
        name: "transmitted",
        line: {width: 2, color: '#0091D4', simplify: false}
    };
    ...
    Plotly.plot('graph', [incident, reflected, reflected_sum, transmitted, boundary, xline],
        layout
    );
